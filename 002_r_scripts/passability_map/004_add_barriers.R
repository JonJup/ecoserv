...
# load data ---------------------------------------------------------------
rivers   <- readRDS("001_data/map_passability/2020-08-25_all_w_flow.RDS")
barrier  <- st_read("001_data/Querbauwerke/2020-08-22_all_barriers.gpkg")
...
# Save to file  -----------------------------------------------------------
saveRDS(rivers2           , paste0("001_data/map_passability/", Sys.Date(), "_rivers_w_flow_and_barriers.RDS"))
